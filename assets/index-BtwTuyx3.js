...
`,rn=t=>t.replace(/^"(.*)"$/,"$1").replace(/^'(.*)'$/,"$1"),B=t=>{var h,l;const n=t.split(/\r?\n/);if(((h=n[0])==null?void 0:h.trim())!=="---")return{content:t.trimStart()};let a=-1;for(let m=1;m<n.length;m+=1)if(((l=n[m])==null?void 0:l.trim())==="---"){a=m;break}if(a===-1)return{content:t.trimStart()};const c=n.slice(1,a),o=n.slice(a+1).join(`
`).trimStart(),r={};for(const m of c){const i=m.trim();if(!i||i.startsWith("#"))continue;const p=i.indexOf(":");if(p===-1)continue;const u=i.slice(0,p).trim(),y=rn(i.slice(p+1).trim());u&&(r[u]=y)}return{title:r.title,description:r.description,ogImage:r.ogImage,publishedAt:r.publishedAt,updatedAt:r.updatedAt,content:o}},R=(t,n)=>{var a,c,o,r,h;return{title:((a=t.title)==null?void 0:a.trim())||n.title,description:((c=t.description)==null?void 0:c.trim())||n.description,ogImage:((o=t.ogImage)==null?void 0:o.trim())||n.ogImage,publishedAt:(r=t.publishedAt)==null?void 0:r.trim(),updatedAt:(h=t.updatedAt||t.publishedAt)==null?void 0:h.trim(),content:t.content}},L=t=>`/og/guides/${t}.png`,N=R(B(Ze),{title:"Guide to Home Recording",description:"Everything you need to know to get professional results from your home studio setup.",ogImage:L("home-recording")}),T=R(B(en),{title:"Studio Session Preparation",description:"Complete checklist and guidelines for preparing for professional recording sessions.",ogImage:L("studio-session-preparation")}),S=R(B(nn),{title:"Preparing Files for Mixing",description:"Essential guidelines for organizing and preparing your multitrack files for professional mixing.",ogImage:L("preparing-files-for-mixing")}),_=R(B(tn),{title:"Preparing Files for Mastering",description:"How to prepare your final mix for the mastering process to achieve the best possible results.",ogImage:L("preparing-files-for-mastering")}),E=R(B(an),{title:"Glossary",description:"Plain-English explanations of the technical terms used across these guides.",ogImage:L("glossary")}),X=[{slug:"home-recording",title:N.title,description:N.description,category:"Recording",downloadUrl:"/guides/home-recording-guide.pdf",icon:ve,content:N.content,ogImage:N.ogImage,publishedAt:N.publishedAt,updatedAt:N.updatedAt},{slug:"studio-session-preparation",title:T.title,description:T.description,category:"Recording",downloadUrl:"/guides/studio-session-preparation.pdf",icon:ce,content:T.content,ogImage:T.ogImage,publishedAt:T.publishedAt,updatedAt:T.updatedAt},{slug:"preparing-files-for-mixing",title:S.title,description:S.description,category:"Mixing",downloadUrl:"/guides/preparing-files-for-mixing.pdf",icon:he,content:S.content,ogImage:S.ogImage,publishedAt:S.publishedAt,updatedAt:S.updatedAt},{slug:"preparing-files-for-mastering",title:_.title,description:_.description,category:"Mastering",downloadUrl:"/guides/preparing-files-for-mastering.pdf",icon:ue,content:_.content,ogImage:_.ogImage,publishedAt:_.publishedAt,updatedAt:_.updatedAt},{slug:"glossary",title:E.title,description:E.description,category:"Reference",downloadUrl:"/guides/glossary.pdf",icon:je,content:E.content,ogImage:E.ogImage,publishedAt:E.publishedAt,updatedAt:E.updatedAt}],sn=t=>X.find(n=>n.slug===t),on=()=>{const t=de();return e.jsxs("div",{className:"min-h-screen bg-background",children:[e.jsx(Q,{...Y.guides}),e.jsx(U,{}),e.jsx("section",{className:"pt-24 pb-8",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"text-center max-w-3xl mx-auto",children:[e.jsx("div",{className:"inline-block border border-border/50 px-4 py-1.5 rounded-full mb-6 text-sm font-mono tracking-wider text-muted-foreground uppercase bg-[#0A0A0E]",children:"Knowledge Hub"}),e.jsxs("h1",{className:"text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8 text-foreground",children:["Guides & ",e.jsx("span",{className:"font-drama italic text-primary font-normal",children:"Downloads."})]}),e.jsx("p",{className:"text-lg text-muted-foreground mb-6",children:"Essential resources to help you prepare for recording sessions, mixing, and mastering. These guides are here to help us get the best out of our collaboration."})]})})}),e.jsx("section",{className:"pt-6 pb-16",children:e.jsx("div",{className:"container-width section-padding",children:e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8",children:X.map(n=>{const a=n.icon;return e.jsx("div",{className:"bg-[#0A0A0E] rounded-[2rem] p-6 lg:p-8 border border-border/50 hover:border-primary/50 transition-all duration-300 shadow-xl group",children:e.jsxs("div",{className:"flex items-start space-x-4",children:[e.jsx("div",{className:"p-3 bg-primary/10 rounded-lg text-primary flex-shrink-0",children:e.jsx(a,{className:"w-6 h-6"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx(G,{to:`/guides/${n.slug}`,className:"text-xl font-semibold text-foreground hover:text-primary transition-colors",children:n.title}),e.jsx("span",{className:"text-xs px-2 py-1 bg-secondary rounded-full text-secondary-foreground",children:n.category})]}),e.jsx("p",{className:"text-muted-foreground mb-4 leading-relaxed",children:n.description}),e.jsxs("div",{className:"flex flex-wrap items-center gap-x-6 gap-y-2",children:[e.jsxs(G,{to:`/guides/${n.slug}`,className:"inline-flex items-center gap-2 text-primary font-medium hover:text-primary/80 transition-colors",children:[e.jsx("span",{children:"Read more"}),e.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"h-4 w-4",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"})})]}),e.jsxs("a",{href:n.downloadUrl,download:!0,className:"inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-muted-foreground transition-colors hover:text-primary",children:[e.jsx(ge,{className:"h-4 w-4","aria-hidden":"true"}),e.jsx("span",{children:"PDF"})]})]})]})]})},n.slug)})})})}),e.jsx("section",{className:"py-24 bg-[#0D0D12] border-t border-border/20 relative z-10",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"max-w-4xl mx-auto",children:[e.jsx("h2",{className:"text-3xl font-bold mb-8 text-center",children:"Why These Guides Matter"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4",children:e.jsx(ce,{className:"w-6 h-6 text-primary"})}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Save Time"}),e.jsx("p",{className:"text-muted-foreground",children:"Sorting out gear, tuning, and file formats beforehand means fewer surprises eating into session time."})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4",children:e.jsx(he,{className:"w-6 h-6 text-primary"})}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Better Results"}),e.jsx("p",{className:"text-muted-foreground",children:"Following these guidelines helps us get the best possible quality out of your music."})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4",children:e.jsx(ue,{className:"w-6 h-6 text-primary"})}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Clear Expectations"}),e.jsx("p",{className:"text-muted-foreground",children:"Knowing what to prepare means we can dive straight into the work when you arrive."})]})]})]})})}),e.jsx("section",{className:"py-24 bg-background",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"text-center max-w-2xl mx-auto",children:[e.jsxs("h2",{className:"text-3xl md:text-4xl font-bold mb-6 text-foreground",children:["Ready to Start Your ",e.jsx("span",{className:"font-drama italic text-primary font-normal",children:"Project?"})]}),e.jsx("p",{className:"text-lg text-muted-foreground mb-10 leading-relaxed",children:"Have questions about any of these guides or ready to book a session? Let's discuss your project and how we can bring your vision to life."}),e.jsx("button",{onClick:n=>{n.preventDefault(),t("/"),setTimeout(()=>{const a=document.getElementById("contact");a&&a.scrollIntoView({behavior:"smooth",block:"start"})},150)},className:"group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden rounded-[2rem] bg-primary text-primary-foreground font-medium magnetic-button shadow-xl shadow-primary/20",children:e.jsx("span",{className:"relative z-10",children:"Get In Touch"})})]})})}),e.jsx(J,{})]})},$=t=>({node:n,children:a,...c})=>{const{id:o,className:r,...h}=c,l=typeof o=="string"?o:"",m=t==="h2"?"mt-8 text-2xl font-semibold text-foreground":t==="h3"?"mt-6 text-xl font-semibold text-foreground":"mt-4 text-lg font-medium text-foreground";return e.jsxs(t,{...h,id:l,className:`group relative scroll-mt-28 ${m} ${r??""}`.trim(),children:[l&&e.jsx("a",{href:`#${l}`,className:"anchor-link absolute -left-8 hidden h-5 w-5 items-center justify-center rounded text-muted-foreground opacity-0 transition hover:text-primary group-hover:flex group-hover:opacity-100 focus-visible:flex focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary","aria-label":`Copy link to ${l.replace(/-/g," ")}`,children:e.jsx(Se,{className:"h-4 w-4"})}),e.jsx("span",{children:a})]})},ln=1400,dn=t=>{const n=new Ce;return n.reset(),t.split(/\r?\n/).map(a=>{const c=a.match(/^(#{2,4})\s+(.*)$/);if(!c)return null;const o=c[1].length,h=c[2].trim().replace(/#+$/,"").trim(),l=h.replace(/^[\*`_]+/,"").replace(/[\*`_]+$/,"");return{id:n.slug(h),title:l,depth:o}}).filter(a=>a!==null)},cn=t=>{if(!t)return;if(/^https?:\/\//i.test(t))return t;const n=t.startsWith("/")?t:`/${t}`;return`${me}${n}`},hn=()=>{const{slug:t}=Ae(),n=t?sn(t):void 0,[a,c]=d.useState(!1),[o,r]=d.useState(""),[h,l]=d.useState(!1),m=d.useRef(null),i=()=>{var s;((s=m.current)==null?void 0:s.timeoutId)!==void 0&&typeof window<"u"&&window.clearTimeout(m.current.timeoutId),m.current=null},p=s=>{if(typeof window>"u"){r(s);return}i();const g=window.setTimeout(()=>{m.current=null},800);m.current={id:s,timeoutId:g},r(s)},u=d.useMemo(()=>n?dn(n.content):[],[n]);d.useEffect(()=>{if(typeof window>"u")return;const s=window.matchMedia(`(min-width: ${ln}px)`),g=f=>{const b=f?f.matches:s.matches;l(b),c(b)};return g(),s.addEventListener("change",g),()=>s.removeEventListener("change",g)},[]),d.useEffect(()=>{u.length!==0&&r(s=>{var g;return s&&u.some(f=>f.id===s)?s:((g=u[0])==null?void 0:g.id)??""})},[u]),d.useEffect(()=>{if(typeof window>"u"||u.length===0)return;const s=new Map,g=120,f=()=>{var ae,re;if(m.current){r(m.current.id);return}const k=window.innerHeight+window.scrollY,v=document.documentElement.scrollHeight,j=(ae=u[u.length-1])==null?void 0:ae.id;if(k>=v-1&&j){r(j);return}if(s.size>0){const D=[...s.entries()].map(([x,A])=>({id:x,top:A.getBoundingClientRect().top-g})),I=D.filter(x=>x.top<=0).sort((x,A)=>x.top-A.top),O=D.filter(x=>x.top>0).sort((x,A)=>x.top-A.top),F=I.length>0?I[I.length-1]:O[0];if(F){r(F.id);return}}const fe=window.scrollY+g;let ne=((re=u[0])==null?void 0:re.id)??"",te=Number.POSITIVE_INFINITY;for(const D of u){const I=document.getElementById(D.id);if(!I)continue;const O=window.getComputedStyle(I),F=parseFloat(O.scrollMarginTop||"0"),x=I.offsetTop-F,A=Math.abs(x-fe);A<te&&(te=A,ne=D.id)}r(ne)},b=new IntersectionObserver(k=>{k.forEach(v=>{const j=v.target.getAttribute("id");j&&(v.isIntersecting?s.set(j,v.target):s.delete(j))}),f()},{root:null,rootMargin:"-120px 0px -50% 0px",threshold:[0,.25,.5,.75,1]});for(const k of u){const v=document.getElementById(k.id);v&&b.observe(v)}return f(),window.addEventListener("scroll",f,{passive:!0}),()=>{b.disconnect(),window.removeEventListener("scroll",f),i()}},[u]);const y=d.useMemo(()=>({h2:$("h2"),h3:$("h3"),h4:$("h4")}),[]);if(!n)return e.jsx(Ie,{to:"/guides",replace:!0});const M=n?$e(n):Y.guides,H=n.icon,Z=d.useMemo(()=>{if(!n)return null;const s=M.canonicalUrl,g=n.publishedAt,f=n.updatedAt??n.publishedAt,b=cn(n.ogImage),k={"@context":"https://schema.org","@type":"Article",headline:n.title,description:n.description,author:{"@type":"Person",name:"Benjamin Mlynek"},mainEntityOfPage:{"@type":"WebPage","@id":s},url:s};return g&&(k.datePublished=g),f&&(k.dateModified=f),b&&(k.image=[b]),k},[n,M]),pe=s=>{if(typeof document>"u"){p(s);return}const g=()=>{const f=document.getElementById(s);f&&f.scrollIntoView({behavior:"smooth",block:"start"})};!h&&a?(c(!1),requestAnimationFrame(()=>requestAnimationFrame(g))):g(),p(s)},ee=(s,g)=>{s.preventDefault(),pe(g)};return e.jsxs("div",{className:"min-h-screen bg-background flex flex-col",children:[e.jsx(Q,{...M}),Z&&e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(Z)}}),e.jsx(U,{}),e.jsx("main",{className:"flex-1 pt-32 pb-24",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"flex flex-col lg:flex-row gap-12 lg:gap-16 items-start relative max-w-[1400px] mx-auto",children:[h&&e.jsxs("aside",{className:"sticky top-32 w-80 shrink-0 flex flex-col max-h-[calc(100vh-10rem)] bg-[#0A0A0E] border border-border/50 rounded-[2rem] overflow-hidden shadow-2xl",children:[e.jsx("div",{className:"px-8 pt-8 pb-6 border-b border-border/10",children:e.jsxs(G,{to:"/guides",className:"inline-flex items-center gap-2 text-sm font-medium text-muted-foreground transition hover:text-primary group",children:[e.jsx(se,{className:"w-4 h-4 transition-transform group-hover:-translate-x-1"}),"Back to guides"]})}),e.jsx("nav",{className:"flex-1 overflow-y-auto px-6 py-6 text-sm text-muted-foreground",children:e.jsx("ul",{className:"space-y-1",children:u.map((s,g)=>{const f=o===s.id,b=s.depth===2,k=b&&g>0,v=s.depth===2?"":s.depth===3?"ml-4":"ml-8";return e.jsx("li",{className:k?"border-t border-border/10 pt-4 mt-4":"",children:e.jsx("a",{href:`#${s.id}`,onClick:j=>ee(j,s.id),className:`relative flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left transition-all ${b?"font-medium text-foreground":"text-foreground/70"} ${v} ${f?"bg-primary/10 text-primary font-medium translate-x-1":"hover:text-primary hover:bg-primary/5 hover:translate-x-1"}`,"aria-current":f?"true":void 0,children:e.jsx("span",{className:"flex-1 leading-snug",children:s.title})})},s.id)})})})]}),e.jsxs("div",{className:"flex-1 w-full max-w-3xl mx-auto lg:mx-0",children:[e.jsxs("div",{className:"flex flex-col gap-6 mb-12 lg:mb-16",children:[e.jsxs("div",{className:"inline-flex flex-wrap items-center gap-3 text-sm text-muted-foreground",children:[e.jsx("span",{className:"rounded-full bg-primary/10 px-3 py-1.5 text-primary flex items-center justify-center",children:e.jsx(H,{className:"h-5 w-5"})}),e.jsx("span",{className:"rounded-full bg-[#0A0A0E] border border-border/50 px-4 py-1.5 text-xs text-foreground font-mono uppercase tracking-wider",children:n.category}),e.jsxs("a",{href:n.downloadUrl,download:!0,className:"inline-flex items-center gap-2 font-mono text-xs text-primary uppercase tracking-wider px-4 py-1.5 rounded-full border border-primary/30 bg-primary/5 transition hover:border-primary/60 hover:bg-primary/10",children:[e.jsx(ge,{className:"h-3.5 w-3.5","aria-hidden":"true"}),e.jsx("span",{children:"Download PDF"})]})]}),e.jsxs("div",{className:"space-y-6",children:[e.jsx("h1",{className:"text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-[1.1]",children:e.jsx("span",{className:"font-drama italic text-primary font-normal",children:n.title})}),e.jsx("p",{className:"text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl",children:n.description})]})]}),u.length>0&&!h&&e.jsxs("div",{className:"mb-12",children:[e.jsxs("button",{onClick:()=>c(s=>!s),className:"w-full inline-flex items-center justify-between rounded-2xl border border-border/50 bg-[#0A0A0E] px-6 py-4 text-sm font-medium text-foreground shadow-sm transition hover:border-primary/50 hover:text-primary","aria-expanded":a,children:[e.jsxs("span",{className:"inline-flex items-center gap-3",children:[e.jsx(Ne,{className:"w-5 h-5 text-primary"}),e.jsx("span",{className:"font-mono uppercase tracking-wider",children:"Table of contents"})]}),e.jsx(se,{className:`w-4 h-4 transition-transform duration-300 ${a?"rotate-90":"-rotate-90"}`})]}),a&&e.jsx("nav",{className:"mt-4 rounded-2xl border border-border/50 bg-[#0A0A0E] p-6 text-sm text-muted-foreground shadow-xl animate-in fade-in slide-in-from-top-4 duration-300",children:e.jsx("ul",{className:"space-y-2",children:u.map(s=>{const g=o===s.id,f=s.depth===2?"":s.depth===3?"pl-4":"pl-8";return e.jsx("li",{children:e.jsx("a",{href:`#${s.id}`,onClick:b=>ee(b,s.id),className:`relative flex w-full items-center gap-2 rounded-xl px-4 py-3 text-left transition-all ${g?"bg-primary/10 text-primary font-medium":"text-foreground/80 hover:text-primary hover:bg-primary/5"} ${f}`,"aria-current":g?"true":void 0,children:e.jsx("span",{className:"flex-1 leading-snug",children:s.title})})},s.id)})})})]}),e.jsxs("div",{className:"space-y-16",children:[e.jsx("div",{className:"guide-prose",children:e.jsx(Te,{remarkPlugins:[Re,Le],rehypePlugins:[Be],components:y,children:n.content})}),e.jsx("div",{className:"bg-[#0A0A0E] border border-border/50 rounded-[2rem] p-8 lg:p-10 shadow-2xl relative overflow-hidden group",children:e.jsxs("div",{className:"relative z-10",children:[e.jsxs("h3",{className:"text-3xl font-bold tracking-tight mb-4",children:["Need more ",e.jsx("span",{className:"font-drama italic text-primary font-normal",children:"resources?"})]}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8 leading-relaxed",children:"Explore the other guides below or reach out if you need help applying these steps to your specific project."}),e.jsx("div",{className:"flex flex-wrap gap-3",children:X.filter(s=>s.slug!==n.slug).map(s=>e.jsx(G,{to:`/guides/${s.slug}`,className:"px-5 py-2.5 text-sm font-medium rounded-full border border-border/50 hover:bg-primary/10 hover:border-primary/50 text-foreground hover:text-primary transition-all duration-300 shadow-sm bg-background/50 backdrop-blur-sm",children:s.title},s.slug))})]})})]})]})]})})}),e.jsx(J,{})]})},un=()=>{const t=V();return d.useEffect(()=>{console.error("404 Error: User attempted to access non-existent route:",t.pathname)},[t.pathname]),e.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-100",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-4xl font-bold mb-4",children:"404"}),e.jsx("p",{className:"text-xl text-gray-600 mb-4",children:"Oops! Page not found"}),e.jsx("a",{href:"/",className:"text-blue-500 hover:text-blue-700 underline",children:"Return to Home"})]})})},gn=()=>e.jsxs(_e,{children:[e.jsx(z,{path:"/",element:e.jsx(Xe,{})}),e.jsx(z,{path:"/guides",element:e.jsx(on,{})}),e.jsx(z,{path:"/guides/:slug",element:e.jsx(hn,{})}),e.jsx(z,{path:"*",element:e.jsx(un,{})})]}),mn=()=>{const{pathname:t,hash:n}=V();return d.useEffect(()=>{if(!n){window.scrollTo({top:0,left:0,behavior:"instant"});return}let a=!1;const c=n.slice(1),o=()=>{var l;a||(l=document.getElementById(c))==null||l.scrollIntoView({block:"start"})};o();const r=typeof document<"u"&&"fonts"in document?document.fonts.ready:Promise.resolve(),h=new Promise(l=>{window.setTimeout(l,500)});return Promise.race([r,h]).then(()=>{requestAnimationFrame(()=>requestAnimationFrame(o))}),()=>{a=!0}},[t,n]),null},pn=()=>e.jsx(ze,{children:e.jsxs(Ee,{children:[e.jsxs("svg",{className:"noise-overlay text-[0px]",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("filter",{id:"noiseFilter",children:e.jsx("feTurbulence",{type:"fractalNoise",baseFrequency:"0.65",numOctaves:"3",stitchTiles:"stitch"})}),e.jsx("rect",{width:"100%",height:"100%",filter:"url(#noiseFilter)"})]}),e.jsx(mn,{}),e.jsx(gn,{})]})});Me.createRoot(document.getElementById("root")).render(e.jsx(pn,{}));export{Oe as s};
