const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/About-zNeTuG7C.js","assets/react-vendors-DYQtuCKQ.js","assets/vendor-PR9BmweM.js","assets/markdown-C5JuTp_C.js","assets/BehindTheScenes-DmJYPjjt.js","assets/Services-CUiMD8ME.js","assets/useScrollAnimation-BffqKtsY.js","assets/Portfolio-CxZ-Vnlx.js","assets/Contact-DH71lKUl.js"])))=>i.map(i=>d[i]);
import{r as l,j as e,C as fe,P as _e,u as Ee,a as Ce,b as K,c as ye,X as be,M as Me,d as De,F as xe,e as ke,H as we,B as Pe,L as O,D as ve,f as Be,N as Re,A as ue,g as ge,i as Le,k as Fe,l as ze,R as Ge,m as W,n as We,o as Oe}from"./react-vendors-DYQtuCKQ.js";import{I as He,J as qe,C as U,K as $e}from"./vendor-PR9BmweM.js";import{b as Ve,c as Ue,d as Ye}from"./markdown-C5JuTp_C.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))h(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&h(c)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function h(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();function Ke(...t){return He(qe(t))}const Qe=_e,Je=l.forwardRef(({className:t,sideOffset:n=4,...r},h)=>e.jsx(fe,{ref:h,sideOffset:n,className:Ke("z-50 overflow-hidden rounded-md border bg-popover px-3 py-1.5 text-sm text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",t),...r}));Je.displayName=fe.displayName;const Xe="modulepreload",Ze=function(t){return"/"+t},me={},P=function(n,r,h){let o=Promise.resolve();if(r&&r.length>0){let c=function(i){return Promise.all(i.map(g=>Promise.resolve(g).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),b=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));o=c(r.map(i=>{if(i=Ze(i),i in me)return;me[i]=!0;const g=i.endsWith(".css"),p=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${i}"]${p}`))return;const m=document.createElement("link");if(m.rel=g?"stylesheet":Xe,g||(m.as="script"),m.crossOrigin="",m.href=i,b&&m.setAttribute("nonce",b),document.head.appendChild(m),g)return new Promise((F,z)=>{m.addEventListener("load",F),m.addEventListener("error",()=>z(new Error(`Unable to preload CSS for ${i}`)))})}))}function s(c){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=c,window.dispatchEvent(u),!u.defaultPrevented)throw c}return o.then(c=>{for(const u of c||[])u.status==="rejected"&&s(u.reason);return n().catch(s)})},en="/assets/studio-9-CwJQ0Tdi.jpg",nn=()=>{const t=l.useRef(null);Ee(()=>{const r=U.timeline({defaults:{ease:"power3.out"}});U.set(".hero-element",{y:40,opacity:0}),U.set(".hero-bg",{scale:1.05}),r.to(".hero-bg",{scale:1,duration:2.5,ease:"power2.out"}),r.to(".hero-element",{y:0,opacity:1,duration:1.2,stagger:.15},"-=2")},{scope:t});const n=(r,h)=>{h.preventDefault();const o=r.substring(1),s=document.getElementById(o);s&&s.scrollIntoView({behavior:"smooth",block:"start"})};return e.jsxs("section",{id:"home",ref:t,className:"relative w-full h-[100dvh] overflow-hidden bg-background",children:[e.jsxs("div",{className:"absolute inset-0 z-0 bg-[#0D0D12] overflow-hidden",children:[e.jsx("img",{src:en,alt:"Studio Background",className:"hero-bg w-full h-full object-cover opacity-40 mix-blend-luminosity"}),e.jsx("div",{className:"absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-[#0D0D12] to-transparent"}),e.jsx("div",{className:"absolute inset-x-0 top-0 h-1/3 bg-gradient-to-b from-[#0D0D12] to-transparent"}),e.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(13,13,18,0.85)_100%)]"})]}),e.jsx("div",{className:"absolute inset-0 z-10 flex flex-col justify-end pb-24 md:pb-32 px-6 md:px-16 container-width w-full",children:e.jsxs("div",{className:"max-w-4xl",children:[e.jsx("p",{className:"hero-element inline-block text-primary font-mono text-sm tracking-widest uppercase mb-6 px-3 py-1 rounded-full border border-primary/20 bg-primary/5",children:"Benjamin Mlynek"}),e.jsxs("h1",{className:"flex flex-col gap-2",children:[e.jsx("span",{className:"hero-element text-3xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground/90",children:"Music Producer &"}),e.jsx("span",{className:"hero-element text-5xl md:text-8xl lg:text-9xl font-drama italic tracking-tight text-foreground leading-[1.1]",children:"Audio Engineer."})]}),e.jsx("p",{className:"hero-element mt-6 md:mt-10 text-lg md:text-xl text-muted-foreground w-full max-w-2xl font-light leading-relaxed",children:"Professional recording, mixing, and production services tailored to your artistry and vision. Based in Odense, Denmark."}),e.jsxs("div",{className:"hero-element mt-10 flex items-center gap-6",children:[e.jsx("a",{href:"#contact",onClick:r=>n("#contact",r),className:"group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden rounded-[2rem] bg-primary text-primary-foreground font-medium magnetic-button",children:e.jsx("span",{className:"relative z-10",children:"Book a Session"})}),e.jsx("a",{href:"#work",onClick:r=>n("#work",r),className:"group relative inline-flex items-center justify-center px-8 py-4 rounded-[2rem] border border-border/50 bg-card/10 backdrop-blur-sm text-foreground font-medium hover:border-primary/50 magnetic-button",children:"Explore Portfolio"})]})]})}),e.jsx("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2 z-20 hero-element flex flex-col items-center",children:e.jsx("a",{href:"#services",onClick:r=>n("#services",r),className:"text-muted-foreground/50 hover:text-primary transition-colors duration-300 flex flex-col items-center gap-2 group cursor-pointer",children:e.jsx(Ce,{className:"w-5 h-5 animate-bounce"})})})]})},Q=()=>{const[t,n]=l.useState(!1),[r,h]=l.useState(!1),o=K(),s=ye();l.useEffect(()=>{const i=()=>{const g=window.scrollY>30||o.pathname!=="/";h(g)};return i(),window.addEventListener("scroll",i),()=>window.removeEventListener("scroll",i)},[o.pathname]);const c=[{name:"Home",href:"#home",isRoute:!1},{name:"About",href:"#about",isRoute:!1},{name:"Work",href:"#work",isRoute:!1},{name:"Services",href:"#services",isRoute:!1},{name:"Guides",href:"/guides",isRoute:!0},{name:"Contact",href:"#contact",isRoute:!1}],u=(i,g)=>{if(g.preventDefault(),i.isRoute)s(i.href);else if(o.pathname!=="/")s("/"),setTimeout(()=>{const p=i.href.substring(1),m=document.getElementById(p);m&&m.scrollIntoView({behavior:"smooth",block:"start"})},100);else{const p=i.href.substring(1),m=document.getElementById(p);m&&m.scrollIntoView({behavior:"smooth",block:"start"})}n(!1)},b=r||t;return e.jsx("div",{className:"fixed top-0 w-full z-50 pointer-events-none flex justify-center px-4 pt-6 transition-all duration-500 max-w-[100vw]",children:e.jsxs("nav",{className:`pointer-events-auto transition-all duration-500 overflow-hidden ${b?`bg-background/80 backdrop-blur-xl border border-border shadow-2xl ${t?"rounded-[2rem]":"rounded-full"} px-6 py-3`:"bg-transparent px-6 py-3"}`,children:[e.jsxs("div",{className:"flex items-center justify-between min-w-[300px] md:min-w-[600px] gap-8",children:[e.jsx("a",{href:"/",onClick:i=>{i.preventDefault(),s("/"),n(!1),window.scrollTo({top:0,behavior:"smooth"})},className:"text-2xl font-drama font-bold text-foreground cursor-pointer tracking-tighter",children:"BM."}),e.jsx("div",{className:"hidden md:flex items-center space-x-8",children:c.map(i=>e.jsx("a",{href:i.href,onClick:g=>u(i,g),className:"text-sm font-medium text-foreground/80 hover:text-primary magnetic-button cursor-pointer",children:i.name},i.name))}),e.jsxs("div",{className:"flex items-center space-x-2",children:[e.jsx("a",{href:"https://instagram.com/benjaminmlynek",target:"_blank",rel:"noopener noreferrer",className:"inline-flex h-10 w-10 items-center justify-center rounded-full text-foreground/80 magnetic-button hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60","aria-label":"Instagram",children:e.jsx("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"currentColor",children:e.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})}),e.jsx("button",{type:"button",className:"md:hidden inline-flex h-10 w-10 items-center justify-center rounded-full text-foreground/80 magnetic-button hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60","aria-label":t?"Close navigation menu":"Open navigation menu","aria-expanded":t,"aria-controls":"mobile-navigation",onClick:()=>n(!t),children:t?e.jsx(be,{size:20}):e.jsx(Me,{size:20})})]})]}),t&&e.jsx("div",{id:"mobile-navigation",className:"md:hidden mt-4 pt-4 border-t border-border/50 flex flex-col items-center space-y-4",children:c.map(i=>e.jsx("a",{href:i.href,onClick:g=>u(i,g),className:"block text-foreground/80 hover:text-primary transition-colors duration-200 cursor-pointer font-medium",children:i.name},i.name))})]})})},H="https://benjaminmlynek.com",je=H.replace(/\/$/,""),J={home:{title:"Benjamin Mlynek - Music Producer & Audio Engineer",description:"Benjamin Mlynek offers professional recording, mixing, and mastering services for artists ready to release polished music. Partner with an experienced engineer who keeps your vision front and center from the first take to the final master.",canonicalUrl:H,ogType:"website"},guides:{title:"Guides & Resources for Artists | Benjamin Mlynek",description:"Step-by-step guides that help artists prepare files, sessions, and workflows for professional recording, mixing, and mastering.",canonicalUrl:`${H}/guides`,ogType:"website"}},tn=t=>({title:`${t.title} | Benjamin Mlynek Guides`,description:t.description,canonicalUrl:`${H}/guides/${t.slug}`,ogType:"article",ogImage:t.ogImage}),X=typeof document<"u",pe=t=>{if(!t)return;if(/^https?:\/\//i.test(t))return t;const n=t.startsWith("/")?t:`/${t}`;return`${je}${n}`},w=(t,n,r)=>{if(!X)return;const h=`meta[${t}="${n}"]`;let o=document.head.querySelector(h);if(!r){o&&document.head.removeChild(o);return}o||(o=document.createElement("meta"),o.setAttribute(t,n),document.head.appendChild(o)),o.setAttribute("content",r)},an=t=>{if(!X||!t)return;let n=document.head.querySelector('link[rel="canonical"]');n||(n=document.createElement("link"),n.setAttribute("rel","canonical"),document.head.appendChild(n)),n.setAttribute("href",t)},Z=({title:t,description:n,canonicalUrl:r,ogType:h="website",ogImage:o})=>(l.useEffect(()=>{!X||!t||(document.title=t,w("property","og:title",t),w("name","twitter:title",t))},[t]),l.useEffect(()=>{n&&(w("name","description",n),w("property","og:description",n),w("name","twitter:description",n))},[n]),l.useEffect(()=>{const s=pe(r??"/");s&&(an(s),w("property","og:url",s))},[r]),l.useEffect(()=>{w("property","og:type",h??"website")},[h]),l.useEffect(()=>{const s=pe(o);w("name","twitter:card",s?"summary_large_image":"summary"),s?(w("property","og:image",s),w("name","twitter:image",s)):(w("property","og:image"),w("name","twitter:image"))},[o]),null),ee=()=>e.jsx("footer",{className:"bg-[#0A0A0E] rounded-t-[4rem] border-t border-border/20 pt-20 pb-10 mt-10 shadow-2xl relative z-10",children:e.jsxs("div",{className:"container-width section-padding",children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-12 mb-16",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h3",{className:"text-3xl font-drama font-bold text-foreground",children:"BM."}),e.jsx("p",{className:"text-muted-foreground font-mono text-sm",children:"Music Producer & Audio Engineer"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"text-lg font-semibold text-foreground",children:"Navigation"}),e.jsxs("div",{className:"flex flex-col space-y-2",children:[e.jsx("a",{href:"/#about",className:"text-muted-foreground hover:text-primary transition-colors magnetic-button origin-left w-fit",children:"About"}),e.jsx("a",{href:"/#work",className:"text-muted-foreground hover:text-primary transition-colors magnetic-button origin-left w-fit",children:"Work"}),e.jsx("a",{href:"/#services",className:"text-muted-foreground hover:text-primary transition-colors magnetic-button origin-left w-fit",children:"Services"}),e.jsx("a",{href:"/guides",className:"text-muted-foreground hover:text-primary transition-colors magnetic-button origin-left w-fit",children:"Guides"})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h4",{className:"text-lg font-semibold text-foreground",children:"Connect"}),e.jsxs("div",{className:"flex flex-col space-y-2",children:[e.jsx("a",{href:"https://instagram.com/benjaminmlynek",target:"_blank",rel:"noopener noreferrer",className:"text-muted-foreground hover:text-primary transition-colors magnetic-button origin-left w-fit",children:"Instagram"}),e.jsx("a",{href:"/#contact",className:"text-muted-foreground hover:text-primary transition-colors magnetic-button origin-left w-fit",children:"Email"})]})]})]}),e.jsx("div",{className:"pt-8 border-t border-border/20 flex flex-col md:flex-row justify-center items-center gap-4",children:e.jsx("p",{className:"text-muted-foreground text-sm font-mono",children:"© 2026 Benjamin Mlynek."})})]})}),rn=l.lazy(()=>P(()=>import("./About-zNeTuG7C.js"),__vite__mapDeps([0,1,2,3]))),sn=l.lazy(()=>P(()=>import("./BehindTheScenes-DmJYPjjt.js"),__vite__mapDeps([4,1,2,3]))),on=l.lazy(()=>P(()=>import("./Services-CUiMD8ME.js"),__vite__mapDeps([5,1,2,3,6]))),ln=l.lazy(()=>P(()=>import("./Portfolio-CxZ-Vnlx.js"),__vite__mapDeps([7,1,2,3,6]))),dn=l.lazy(()=>P(()=>import("./Contact-DH71lKUl.js"),__vite__mapDeps([8,1,2,3,6]))),D=({id:t})=>e.jsx("section",{id:t,className:"py-20",children:e.jsx("div",{className:"container-width section-padding",children:e.jsx("div",{className:"h-32 rounded-2xl bg-card/40 animate-pulse","aria-hidden":"true"})})}),cn=()=>e.jsxs("div",{className:"min-h-screen bg-background",children:[e.jsx(Z,{...J.home}),e.jsx(Q,{}),e.jsx(nn,{}),e.jsx(l.Suspense,{fallback:e.jsx(D,{id:"about"}),children:e.jsx(rn,{})}),e.jsx(l.Suspense,{fallback:e.jsx(D,{id:"behind-scenes"}),children:e.jsx(sn,{})}),e.jsx(l.Suspense,{fallback:e.jsx(D,{id:"work"}),children:e.jsx(ln,{})}),e.jsx(l.Suspense,{fallback:e.jsx(D,{id:"services"}),children:e.jsx(on,{})}),e.jsx(l.Suspense,{fallback:e.jsx(D,{id:"contact"}),children:e.jsx(dn,{})}),e.jsx(ee,{})]}),hn=`---
...
> Even with the best mixing or mastering engineer, a track can only sound as good as the recordings allow. Capturing clean, balanced, and expressive performances at home is entirely possible. It just requires attention to detail and a few smart choices. This guide will help you get professional-sounding results from your home setup. These are guidelines, not gospel. They're refined over time, and there's more than one way to get a great result.
...
### Acoustic Guitar
> An acoustic guitar's tone is decided almost entirely by where you point one mic, not by an elaborate setup. It's a single, mono sound source, and it deserves to be tracked like one.  
> Getting a bright, balanced tone at the mic saves you from ever needing to rescue a boomy or nasal recording afterward, since heavy correction on acoustic guitar tends to reveal itself rather than disappear.  
> Editing options are limited once you're past tracking; acoustic parts don't take well to being chopped up or time-stretched, so the takes need to be right going in.

#### **Start With Intent, Then Pick the Mic**
Before setting anything up, decide what the acoustic actually needs to do in the song: sit as a bright, rhythmic layer inside a dense, produced arrangement, or stand on its own as a natural, balanced solo instrument. That call shapes everything after it.

- **A small-diaphragm <a href="/guides/glossary#condenser-mic" class="glossary-link" target="_blank" rel="noopener noreferrer">condenser</a> is the right tool for either goal.** It's brighter, more focused, and more detailed than a large-diaphragm condenser, and it picks up noticeably less of the room, which matters since most home spaces don't sound good enough to want more of in the signal.
- **Skip the large-diaphragm condenser here** unless you're tracking in an exceptional-sounding room. Otherwise it mostly just adds more of a mediocre room to the recording.

#### **Mic It Like the Mono Instrument It Is**
An acoustic guitar is one instrument producing sound from one place, so treat it that way rather than reaching for elaborate multi-mic or stereo setups aimed at the guitar itself.

- **Point a single mic at the 12th fret**, straight on rather than angled, about 30–45 cm (12–18 inches) away. That's the starting point for most acoustic guitar parts.
- **Listen and adjust from there.** Too boomy or woolly: pull the mic back a little, or shift it slightly toward the neck, aiming more at the 10th fret than the 12th, to back off the <a href="/guides/glossary#proximity-effect" class="glossary-link" target="_blank" rel="noopener noreferrer">proximity effect</a>. Too thin or lacking body: move it a little closer, or angle it slightly toward the body, nearer to where the neck meets it.
- **Skip multi-mic setups aimed at the guitar itself** (one mic at the fret, another at the bridge or body, one over the player's shoulder), and skip stereo-mic'ing the instrument itself. Two mics pointed at sharply different angles on the same source pick up meaningfully different tones, and it reads as inconsistent rather than wide.

#### **Reserve Room Mics for a Solo, Intimate Performance**
For a guitar sitting inside a fuller arrangement, a single close mic is normally all you need. Save room mics for when the acoustic is genuinely exposed, like a solo singer-songwriter performance where the goal is an intimate, in-the-room feel.

- **Use a stereo pair in an X/Y arrangement**, about 2.5–4.5 m (8–15 feet) back from the guitar, still pointed at it. Keeping the two mics right on top of or next to each other at a 90-degree angle avoids the <a href="/guides/glossary#phase" class="glossary-link" target="_blank" rel="noopener noreferrer">phase</a> problems a spaced pair can introduce.
- **Treat the room mic as a subtle blend, not a feature.** On its own, a home-studio room track rarely sounds impressive; its job is to nudge the close mic from flat and mono toward a bit of natural width and depth, not to carry the tone.
- **If the room genuinely doesn't sound good, skip it.** A close mic on its own, with a touch of reverb added afterward, beats forcing in a room sound that's actively working against the take.

#### **Double It for a Big, Modern Sound**
For a bright, wide, contemporary acoustic tone, the kind that cuts through a full band arrangement, track two passes with the same close-mic setup and pan them hard left and right, the same doubling approach used for rhythm guitar.

- **Acoustic doubles are forgiving.** The two passes don't need to line up as tightly as an electric double does; a little natural drift in timing is part of what makes it sound wide rather than synthetic.
- **Work in long sections, not short punch-ins.** Acoustic parts carry too much ambience and tail to chop into two- or four-bar chunks the way a tight electric part can. Track full sections, a verse or a chorus at a time, and double each one right away while the playing intensity and the player's position are still consistent.

Label your tracks clearly inside your <a href="/guides/glossary#daw" class="glossary-link" target="_blank" rel="noopener noreferrer">DAW</a>:
- <span class="guide-chip">Acoustic Guitar</span>  
- <span class="guide-chip">Acoustic Guitar L</span>  
- <span class="guide-chip">Acoustic Guitar R</span>  
- <span class="guide-chip">Acoustic Room</span>

#### **Watch for the Small Things That Wreck a Take**
A single sensitive mic on an otherwise exposed instrument leaves nowhere to hide a handful of common problems:

- **Click bleed.** Do a quick test pass and listen back at a healthy volume before committing to full takes; a close mic on a quiet source picks up more click bleed than you'd expect.
- **A player who moves.** Even shifting 15–20 cm (six to eight inches), or changing the angle they're sitting at, is enough for a small-diaphragm condenser to pick up a noticeably different tone. Get them settled into a comfortable position before you start, and avoid breaking up a song mid-take if a player wants to stand and stretch; matching that exact tone again afterward is genuinely difficult.
- **Fading intensity.** Players often play acoustic guitar harder for a recording than they're used to playing it casually, and that energy tends to drop as a session goes on. Listen for a strum or pick attack that's quietly gotten softer than where the song started.
- **Tuning.** An acoustic with a built-in pickup makes this easy: plug straight into a tuner. Without one, a clip-on headstock tuner works in a pinch, though it's less accurate; running the mic signal back out to a tuner is a solid workaround if you need something more reliable.

#### **Punch In Carefully, or Not at All**
Punching into an acoustic guitar part cold rarely sounds natural; there's too much ring and tail for a clean drop-in.

- **Have the player play along into the punch**, the same approach used for drums, rather than dropping in cold.
- **Look for a natural break to land the punch in**, a stop, a rest, a rhythmic gap, rather than punching mid-strum.
- **If a clean <a href="/guides/glossary#punch-in" class="glossary-link" target="_blank" rel="noopener noreferrer">punch-in</a> genuinely isn't working**, duplicate the track and record the alternate part on a second track, then <a href="/guides/glossary#crossfade" class="glossary-link" target="_blank" rel="noopener noreferrer">crossfade</a> between them. Treat that as a fallback, not a first choice: acoustic parts don't take well to being edited or time-stretched afterward, artifacts show up fast and are hard to hide. Get the take right at the source instead of planning to fix it later.

#### **The Same Approach Works for Other Acoustic Instruments**
These principles carry over to other acoustic stringed instruments too, cello, violin, ukulele, and the rest. A small-diaphragm condenser pointed at roughly where the neck meets the body, with the same restraint around room mics, is a solid starting point for any of them.

#### **What to Deliver to Your Mixer**
A finished acoustic guitar session handed off for mixing should include:
- A bright, well-balanced tone captured at the source, not one relying on EQ to fix a boomy or nasal mic placement
- Full-length takes edited in long sections, not a patchwork of short punch-ins
- Both doubled passes, if doubled, panned and labeled clearly
- A room mic track, only if one was actually used and adds something on its own
...
Comping and edit cleanup aren't really on the table here either way, so there's less to hand off than with other instruments, but that also means there's less room for a mixer to fix a shaky performance after the fact.

> If the tone is boomy, thin, or inconsistent coming off the mic, no amount of mixing fully undoes that afterward, and acoustic guitar punishes heavy editing more than almost any other instrument. Get the mic position and the performance right at the source; that's what makes it sound professional later.
...
- **Know the mic's <a href="/guides/glossary#proximity-effect" class="glossary-link" target="_blank" rel="noopener noreferrer">proximity effect</a> and use it on purpose.** Getting closer builds up low end, which is part of why a screamer right on the capsule sounds so huge. Stepping back trims that low end out and brightens things up. Pull back a little for a clean, bright lead vocal; get right in for aggressive, high-energy parts.
...
> Whether you’re recording in your own space or booking time at a professional studio, proper preparation will help you capture better performances, stay efficient, and keep creativity flowing. Studio time can be expensive and fast-paced, so being organized beforehand lets you focus entirely on the music once the session begins. These are guidelines, not gospel. They're refined over time, and there's more than one way to get a great result.
...
- [x] Session backed up after recording`,gn=`---
...
> To ensure the best possible result when sending your project for mixing, it's important that everything is well-organized, properly labeled, and exported in a format that gives the mixing engineer full flexibility. Below you'll find a detailed checklist and explanations to help you prepare your session for mixing. These are guidelines, not gospel. They're refined over time, and there's more than one way to get a great result. If any questions should arise, feel free to get a hold of me either via mail or phone.
...
For the full breakdown of what a finished session should include per instrument, DI vs. mic'd tone, how many doubles, whether pitch and timing have already been checked, see the "What to Deliver to Your Mixer" checklist in each instrument's section of the <a href="/guides/home-recording">Home Recording guide</a>:
- <a href="/guides/home-recording#what-to-deliver-to-your-mixer">Drums</a>  
- <a href="/guides/home-recording#what-to-deliver-to-your-mixer-1">Electric Guitar</a>  
- <a href="/guides/home-recording#what-to-deliver-to-your-mixer-2">Bass</a>  
- <a href="/guides/home-recording#what-to-deliver-to-your-mixer-3">Acoustic Guitar</a>  
- <a href="/guides/home-recording#what-to-deliver-to-your-mixer-4">Vocals</a>
...
- [x] <a href="/guides/glossary#bpm" class="glossary-link" target="_blank" rel="noopener noreferrer">BPM</a> and notes provided`,mn=`---
...
> Before sending your mix for mastering, it’s important to make sure your mix is properly prepared. The goal is to give the mastering engineer enough headroom, clarity, and consistency to bring your track to its full potential without distortion or compromise. These are guidelines, not gospel. They're refined over time, and there's more than one way to get a great result.
...
- [x] File clearly named and labeled`,pn=`---
title: "Glossary"
...
### Proximity Effect
The buildup of low end that happens as a directional mic gets closer to its source. It's why a vocalist or instrument right on the capsule sounds noticeably bassier than the same source a foot back. Used on purpose, it's a placement tool: move in for more low end and size, pull back for a thinner, brighter, more natural balance.
...
`,fn=t=>t.replace(/^"(.*)"$/,"$1").replace(/^'(.*)'$/,"$1"),B=t=>{var c,u;const n=t.split(/\r?\n/);if(((c=n[0])==null?void 0:c.trim())!=="---")return{content:t.trimStart()};let r=-1;for(let b=1;b<n.length;b+=1)if(((u=n[b])==null?void 0:u.trim())==="---"){r=b;break}if(r===-1)return{content:t.trimStart()};const h=n.slice(1,r),o=n.slice(r+1).join(`
`).trimStart(),s={};for(const b of h){const i=b.trim();if(!i||i.startsWith("#"))continue;const g=i.indexOf(":");if(g===-1)continue;const p=i.slice(0,g).trim(),m=fn(i.slice(g+1).trim());p&&(s[p]=m)}return{title:s.title,description:s.description,ogImage:s.ogImage,publishedAt:s.publishedAt,updatedAt:s.updatedAt,content:o}},R=(t,n)=>{var r,h,o,s,c;return{title:((r=t.title)==null?void 0:r.trim())||n.title,description:((h=t.description)==null?void 0:h.trim())||n.description,ogImage:((o=t.ogImage)==null?void 0:o.trim())||n.ogImage,publishedAt:(s=t.publishedAt)==null?void 0:s.trim(),updatedAt:(c=t.updatedAt||t.publishedAt)==null?void 0:c.trim(),content:t.content}},L=t=>`/og/guides/${t}.png`,T=R(B(hn),{title:"Guide to Home Recording",description:"Everything you need to know to get professional results from your home studio setup.",ogImage:L("home-recording")}),S=R(B(un),{title:"Studio Session Preparation",description:"Complete checklist and guidelines for preparing for professional recording sessions.",ogImage:L("studio-session-preparation")}),_=R(B(gn),{title:"Preparing Files for Mixing",description:"Essential guidelines for organizing and preparing your multitrack files for professional mixing.",ogImage:L("preparing-files-for-mixing")}),E=R(B(mn),{title:"Preparing Files for Mastering",description:"How to prepare your final mix for the mastering process to achieve the best possible results.",ogImage:L("preparing-files-for-mastering")}),C=R(B(pn),{title:"Glossary",description:"Plain-English explanations of the technical terms used across these guides.",ogImage:L("glossary")}),ne=[{slug:"home-recording",title:T.title,description:T.description,category:"Recording",downloadUrl:"/guides/home-recording-guide.pdf",icon:De,content:T.content,ogImage:T.ogImage,publishedAt:T.publishedAt,updatedAt:T.updatedAt},{slug:"studio-session-preparation",title:S.title,description:S.description,category:"Recording",downloadUrl:"/guides/studio-session-preparation.pdf",icon:xe,content:S.content,ogImage:S.ogImage,publishedAt:S.publishedAt,updatedAt:S.updatedAt},{slug:"preparing-files-for-mixing",title:_.title,description:_.description,category:"Mixing",downloadUrl:"/guides/preparing-files-for-mixing.pdf",icon:ke,content:_.content,ogImage:_.ogImage,publishedAt:_.publishedAt,updatedAt:_.updatedAt},{slug:"preparing-files-for-mastering",title:E.title,description:E.description,category:"Mastering",downloadUrl:"/guides/preparing-files-for-mastering.pdf",icon:we,content:E.content,ogImage:E.ogImage,publishedAt:E.publishedAt,updatedAt:E.updatedAt},{slug:"glossary",title:C.title,description:C.description,category:"Reference",downloadUrl:"/guides/glossary.pdf",icon:Pe,content:C.content,ogImage:C.ogImage,publishedAt:C.publishedAt,updatedAt:C.updatedAt}],yn=t=>ne.find(n=>n.slug===t),bn=()=>{const t=ye();return e.jsxs("div",{className:"min-h-screen bg-background",children:[e.jsx(Z,{...J.guides}),e.jsx(Q,{}),e.jsx("section",{className:"pt-24 pb-8",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"text-center max-w-3xl mx-auto",children:[e.jsx("div",{className:"inline-block border border-border/50 px-4 py-1.5 rounded-full mb-6 text-sm font-mono tracking-wider text-muted-foreground uppercase bg-[#0A0A0E]",children:"Knowledge Hub"}),e.jsxs("h1",{className:"text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8 text-foreground",children:["Guides & ",e.jsx("span",{className:"font-drama italic text-primary font-normal",children:"Downloads."})]}),e.jsx("p",{className:"text-lg text-muted-foreground mb-6",children:"Essential resources to help you prepare for recording sessions, mixing, and mastering. These guides are here to help us get the best out of our collaboration."})]})})}),e.jsx("section",{className:"pt-6 pb-16",children:e.jsx("div",{className:"container-width section-padding",children:e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8",children:ne.map(n=>{const r=n.icon;return e.jsx("div",{className:"bg-[#0A0A0E] rounded-[2rem] p-6 lg:p-8 border border-border/50 hover:border-primary/50 transition-all duration-300 shadow-xl group",children:e.jsxs("div",{className:"flex items-start space-x-4",children:[e.jsx("div",{className:"p-3 bg-primary/10 rounded-lg text-primary flex-shrink-0",children:e.jsx(r,{className:"w-6 h-6"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx(O,{to:`/guides/${n.slug}`,className:"text-xl font-semibold text-foreground hover:text-primary transition-colors",children:n.title}),e.jsx("span",{className:"text-xs px-2 py-1 bg-secondary rounded-full text-secondary-foreground",children:n.category})]}),e.jsx("p",{className:"text-muted-foreground mb-4 leading-relaxed",children:n.description}),e.jsxs("div",{className:"flex flex-wrap items-center gap-x-6 gap-y-2",children:[e.jsxs(O,{to:`/guides/${n.slug}`,className:"inline-flex items-center gap-2 text-primary font-medium hover:text-primary/80 transition-colors",children:[e.jsx("span",{children:"Read more"}),e.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"h-4 w-4",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"})})]}),e.jsxs("a",{href:n.downloadUrl,download:!0,className:"inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-muted-foreground transition-colors hover:text-primary",children:[e.jsx(ve,{className:"h-4 w-4","aria-hidden":"true"}),e.jsx("span",{children:"PDF"})]})]})]})]})},n.slug)})})})}),e.jsx("section",{className:"py-24 bg-[#0D0D12] border-t border-border/20 relative z-10",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"max-w-4xl mx-auto",children:[e.jsx("h2",{className:"text-3xl font-bold mb-8 text-center",children:"Why These Guides Matter"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4",children:e.jsx(xe,{className:"w-6 h-6 text-primary"})}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Save Time"}),e.jsx("p",{className:"text-muted-foreground",children:"Sorting out gear, tuning, and file formats beforehand means fewer surprises eating into session time."})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4",children:e.jsx(ke,{className:"w-6 h-6 text-primary"})}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Better Results"}),e.jsx("p",{className:"text-muted-foreground",children:"Following these guidelines helps us get the best possible quality out of your music."})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4",children:e.jsx(we,{className:"w-6 h-6 text-primary"})}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"Clear Expectations"}),e.jsx("p",{className:"text-muted-foreground",children:"Knowing what to prepare means we can dive straight into the work when you arrive."})]})]})]})})}),e.jsx("section",{className:"py-24 bg-background",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"text-center max-w-2xl mx-auto",children:[e.jsxs("h2",{className:"text-3xl md:text-4xl font-bold mb-6 text-foreground",children:["Ready to Start Your ",e.jsx("span",{className:"font-drama italic text-primary font-normal",children:"Project?"})]}),e.jsx("p",{className:"text-lg text-muted-foreground mb-10 leading-relaxed",children:"Have questions about any of these guides or ready to book a session? Let's discuss your project and how we can bring your vision to life."}),e.jsx("button",{onClick:n=>{n.preventDefault(),t("/"),setTimeout(()=>{const r=document.getElementById("contact");r&&r.scrollIntoView({behavior:"smooth",block:"start"})},150)},className:"group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden rounded-[2rem] bg-primary text-primary-foreground font-medium magnetic-button shadow-xl shadow-primary/20",children:e.jsx("span",{className:"relative z-10",children:"Get In Touch"})})]})})}),e.jsx(ee,{})]})},Y=t=>({node:n,children:r,...h})=>{const{id:o,className:s,...c}=h,u=typeof o=="string"?o:"",b=t==="h2"?"mt-8 text-2xl font-semibold text-foreground":t==="h3"?"mt-6 text-xl font-semibold text-foreground":"mt-4 text-lg font-medium text-foreground";return e.jsxs(t,{...c,id:u,className:`group relative scroll-mt-28 ${b} ${s??""}`.trim(),children:[u&&e.jsx("a",{href:`#${u}`,className:"anchor-link absolute -left-8 hidden h-5 w-5 items-center justify-center rounded text-muted-foreground opacity-0 transition hover:text-primary group-hover:flex group-hover:opacity-100 focus-visible:flex focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary","aria-label":`Copy link to ${u.replace(/-/g," ")}`,children:e.jsx(ze,{className:"h-4 w-4"})}),e.jsx("span",{children:r})]})},xn=1400,kn=t=>{const n=new $e;return n.reset(),t.split(/\r?\n/).map(r=>{const h=r.match(/^(#{2,4})\s+(.*)$/);if(!h)return null;const o=h[1].length,c=h[2].trim().replace(/#+$/,"").trim(),u=c.replace(/^[\*`_]+/,"").replace(/[\*`_]+$/,"");return{id:n.slug(c),title:u,depth:o}}).filter(r=>r!==null)},wn=t=>{if(!t)return;if(/^https?:\/\//i.test(t))return t;const n=t.startsWith("/")?t:`/${t}`;return`${je}${n}`},vn=()=>{const{slug:t}=Be(),n=t?yn(t):void 0,[r,h]=l.useState(!1),[o,s]=l.useState(""),[c,u]=l.useState(!1),[b,i]=l.useState(!1),[g,p]=l.useState(!1),m=l.useRef(null),F=l.useRef(null),z=l.useRef(null),te=l.useRef(null),q=l.useRef(!1),ae=()=>{var a;((a=m.current)==null?void 0:a.timeoutId)!==void 0&&typeof window<"u"&&window.clearTimeout(m.current.timeoutId),m.current=null},re=a=>{if(typeof window>"u"){s(a);return}ae();const d=window.setTimeout(()=>{m.current=null},800);m.current={id:a,timeoutId:d},s(a)},x=l.useMemo(()=>n?kn(n.content):[],[n]);l.useEffect(()=>{if(typeof window>"u")return;const a=window.matchMedia(`(min-width: ${xn}px)`),d=f=>{const y=f?f.matches:a.matches;u(y),h(y),y&&(p(!1),i(!1))};return d(),a.addEventListener("change",d),()=>a.removeEventListener("change",d)},[]),l.useEffect(()=>{x.length!==0&&s(a=>{var d;return a&&x.some(f=>f.id===a)?a:((d=x[0])==null?void 0:d.id)??""})},[x]),l.useEffect(()=>{if(typeof window>"u"||x.length===0)return;const a=new Map,d=120,f=()=>{var ce,he;if(m.current){s(m.current.id);return}const k=window.innerHeight+window.scrollY,j=document.documentElement.scrollHeight,A=(ce=x[x.length-1])==null?void 0:ce.id;if(k>=j-1&&A){s(A);return}if(a.size>0){const M=[...a.entries()].map(([v,N])=>({id:v,top:N.getBoundingClientRect().top-d})),I=M.filter(v=>v.top<=0).sort((v,N)=>v.top-N.top),V=M.filter(v=>v.top>0).sort((v,N)=>v.top-N.top),G=I.length>0?I[I.length-1]:V[0];if(G){s(G.id);return}}const Se=window.scrollY+d;let le=((he=x[0])==null?void 0:he.id)??"",de=Number.POSITIVE_INFINITY;for(const M of x){const I=document.getElementById(M.id);if(!I)continue;const V=window.getComputedStyle(I),G=parseFloat(V.scrollMarginTop||"0"),v=I.offsetTop-G,N=Math.abs(v-Se);N<de&&(de=N,le=M.id)}s(le)},y=new IntersectionObserver(k=>{k.forEach(j=>{const A=j.target.getAttribute("id");A&&(j.isIntersecting?a.set(A,j.target):a.delete(A))}),f()},{root:null,rootMargin:"-120px 0px -50% 0px",threshold:[0,.25,.5,.75,1]});for(const k of x){const j=document.getElementById(k.id);j&&y.observe(j)}return f(),window.addEventListener("scroll",f,{passive:!0}),()=>{y.disconnect(),window.removeEventListener("scroll",f),ae()}},[x]),l.useEffect(()=>{if(typeof window>"u"||c||x.length===0){i(!1);return}const a=F.current;if(!a)return;const d=new IntersectionObserver(([f])=>i(!f.isIntersecting),{rootMargin:"-120px 0px 0px 0px"});return d.observe(a),()=>d.disconnect()},[c,x.length]),l.useEffect(()=>{if(!g||typeof window>"u")return;const a=d=>{d.key==="Escape"&&p(!1)};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[g]),l.useEffect(()=>{var a;if(g){q.current=!0;const d=(a=te.current)==null?void 0:a.querySelector("button, a[href]");d==null||d.focus()}else q.current&&(q.current=!1,requestAnimationFrame(()=>{var d;(d=z.current)==null||d.focus()}))},[g]);const Ae=l.useMemo(()=>({h2:Y("h2"),h3:Y("h3"),h4:Y("h4")}),[]);if(!n)return e.jsx(Re,{to:"/guides",replace:!0});const $=n?tn(n):J.guides,Ne=n.icon,se=l.useMemo(()=>{if(!n)return null;const a=$.canonicalUrl,d=n.publishedAt,f=n.updatedAt??n.publishedAt,y=wn(n.ogImage),k={"@context":"https://schema.org","@type":"Article",headline:n.title,description:n.description,author:{"@type":"Person",name:"Benjamin Mlynek"},mainEntityOfPage:{"@type":"WebPage","@id":a},url:a};return d&&(k.datePublished=d),f&&(k.dateModified=f),y&&(k.image=[y]),k},[n,$]),Ie=a=>{if(typeof document>"u"){re(a);return}const d=()=>{const y=document.getElementById(a);y&&y.scrollIntoView({behavior:"smooth",block:"start"})};!c&&r||g?(h(!1),p(!1),requestAnimationFrame(()=>requestAnimationFrame(d))):d(),re(a)},oe=(a,d)=>{a.preventDefault(),Ie(d)},Te=()=>{const a=()=>{typeof window<"u"&&window.scrollTo({top:0,behavior:"smooth"})};!c&&r||g?(h(!1),p(!1),requestAnimationFrame(()=>requestAnimationFrame(a))):a()},ie=()=>x.map(a=>{const d=o===a.id,f=a.depth===2?"":a.depth===3?"pl-4":"pl-8";return e.jsx("li",{children:e.jsx("a",{href:`#${a.id}`,onClick:y=>oe(y,a.id),className:`relative flex w-full items-center gap-2 rounded-xl px-4 py-3 text-left transition-all ${d?"bg-primary/10 text-primary font-medium":"text-foreground/80 hover:text-primary hover:bg-primary/5"} ${f}`,"aria-current":d?"true":void 0,children:e.jsx("span",{className:"flex-1 leading-snug",children:a.title})})},a.id)});return e.jsxs("div",{className:"min-h-screen bg-background flex flex-col",children:[e.jsx(Z,{...$}),se&&e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(se)}}),e.jsx(Q,{}),e.jsx("main",{className:"flex-1 pt-32 pb-24",children:e.jsx("div",{className:"container-width section-padding",children:e.jsxs("div",{className:"flex flex-col lg:flex-row gap-12 lg:gap-16 items-start relative max-w-[1400px] mx-auto",children:[c&&e.jsxs("aside",{className:"sticky top-32 w-80 shrink-0 flex flex-col max-h-[calc(100vh-10rem)] bg-[#0A0A0E] border border-border/50 rounded-[2rem] overflow-hidden shadow-2xl",children:[e.jsx("div",{className:"px-8 pt-8 pb-6 border-b border-border/10",children:e.jsxs(O,{to:"/guides",className:"inline-flex items-center gap-2 text-sm font-medium text-muted-foreground transition hover:text-primary group",children:[e.jsx(ue,{className:"w-4 h-4 transition-transform group-hover:-translate-x-1"}),"Back to guides"]})}),e.jsx("nav",{className:"flex-1 overflow-y-auto px-6 py-6 text-sm text-muted-foreground",children:e.jsx("ul",{className:"space-y-1",children:x.map((a,d)=>{const f=o===a.id,y=a.depth===2,k=y&&d>0,j=a.depth===2?"":a.depth===3?"ml-4":"ml-8";return e.jsx("li",{className:k?"border-t border-border/10 pt-4 mt-4":"",children:e.jsx("a",{href:`#${a.id}`,onClick:A=>oe(A,a.id),className:`relative flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left transition-all ${y?"font-medium text-foreground":"text-foreground/70"} ${j} ${f?"bg-primary/10 text-primary font-medium translate-x-1":"hover:text-primary hover:bg-primary/5 hover:translate-x-1"}`,"aria-current":f?"true":void 0,children:e.jsx("span",{className:"flex-1 leading-snug",children:a.title})})},a.id)})})})]}),e.jsxs("div",{className:"flex-1 w-full max-w-3xl mx-auto lg:mx-0",children:[e.jsxs("div",{className:"flex flex-col gap-6 mb-12 lg:mb-16",children:[e.jsxs("div",{className:"inline-flex flex-wrap items-center gap-3 text-sm text-muted-foreground",children:[e.jsx("span",{className:"rounded-full bg-primary/10 px-3 py-1.5 text-primary flex items-center justify-center",children:e.jsx(Ne,{className:"h-5 w-5"})}),e.jsx("span",{className:"rounded-full bg-[#0A0A0E] border border-border/50 px-4 py-1.5 text-xs text-foreground font-mono uppercase tracking-wider",children:n.category}),e.jsxs("a",{href:n.downloadUrl,download:!0,className:"inline-flex items-center gap-2 font-mono text-xs text-primary uppercase tracking-wider px-4 py-1.5 rounded-full border border-primary/30 bg-primary/5 transition hover:border-primary/60 hover:bg-primary/10",children:[e.jsx(ve,{className:"h-3.5 w-3.5","aria-hidden":"true"}),e.jsx("span",{children:"Download PDF"})]})]}),e.jsxs("div",{className:"space-y-6",children:[e.jsx("h1",{className:"text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-[1.1]",children:e.jsx("span",{className:"font-drama italic text-primary font-normal",children:n.title})}),e.jsx("p",{className:"text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl",children:n.description})]})]}),x.length>0&&!c&&e.jsxs("div",{className:"mb-12",ref:F,children:[e.jsxs("button",{onClick:()=>h(a=>!a),className:"w-full inline-flex items-center justify-between rounded-2xl border border-border/50 bg-[#0A0A0E] px-6 py-4 text-sm font-medium text-foreground shadow-sm transition hover:border-primary/50 hover:text-primary","aria-expanded":r,children:[e.jsxs("span",{className:"inline-flex items-center gap-3",children:[e.jsx(ge,{className:"w-5 h-5 text-primary"}),e.jsx("span",{className:"font-mono uppercase tracking-wider",children:"Table of contents"})]}),e.jsx(ue,{className:`w-4 h-4 transition-transform duration-300 ${r?"rotate-90":"-rotate-90"}`})]}),r&&e.jsx("nav",{className:"mt-4 rounded-2xl border border-border/50 bg-[#0A0A0E] p-6 text-sm text-muted-foreground shadow-xl animate-in fade-in slide-in-from-top-4 duration-300",children:e.jsx("ul",{className:"space-y-2",children:ie()})})]}),e.jsxs("div",{className:"space-y-16",children:[e.jsx("div",{className:"guide-prose",children:e.jsx(Le,{remarkPlugins:[Ue,Ye],rehypePlugins:[Ve],components:Ae,children:n.content})}),e.jsx("div",{className:"bg-[#0A0A0E] border border-border/50 rounded-[2rem] p-8 lg:p-10 shadow-2xl relative overflow-hidden group",children:e.jsxs("div",{className:"relative z-10",children:[e.jsxs("h3",{className:"text-3xl font-bold tracking-tight mb-4",children:["Need more ",e.jsx("span",{className:"font-drama italic text-primary font-normal",children:"resources?"})]}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8 leading-relaxed",children:"Explore the other guides below or reach out if you need help applying these steps to your specific project."}),e.jsx("div",{className:"flex flex-wrap gap-3",children:ne.filter(a=>a.slug!==n.slug).map(a=>e.jsx(O,{to:`/guides/${a.slug}`,className:"px-5 py-2.5 text-sm font-medium rounded-full border border-border/50 hover:bg-primary/10 hover:border-primary/50 text-foreground hover:text-primary transition-all duration-300 shadow-sm bg-background/50 backdrop-blur-sm",children:a.title},a.slug))})]})})]})]})]})})}),b&&e.jsxs("button",{ref:z,onClick:()=>{h(!1),p(!0)},"aria-haspopup":"dialog","aria-expanded":g,className:`fixed bottom-6 left-1/2 z-30 -translate-x-1/2 inline-flex items-center gap-2 rounded-full border border-border/50 bg-[#0A0A0E] px-5 py-3 text-sm font-medium text-foreground shadow-2xl transition-all duration-300 hover:border-primary/50 hover:text-primary animate-in fade-in slide-in-from-bottom-4 ${g?"invisible pointer-events-none":""}`,children:[e.jsx(ge,{className:"w-4 h-4 text-primary"}),e.jsx("span",{className:"font-mono text-xs uppercase tracking-wider",children:"Contents"})]}),g&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"fixed inset-0 z-40 bg-background/80 backdrop-blur-sm animate-in fade-in duration-200",onClick:()=>p(!1),"aria-hidden":"true"}),e.jsxs("div",{ref:te,role:"dialog","aria-modal":"true","aria-label":"Table of contents",className:"fixed inset-x-0 bottom-0 z-50 max-h-[75vh] overflow-y-auto rounded-t-[2rem] border-t border-border/50 bg-[#0A0A0E] p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] shadow-2xl animate-in fade-in slide-in-from-bottom-8 duration-300",children:[e.jsxs("div",{className:"sticky -top-6 z-10 mb-4 flex items-center justify-between bg-[#0A0A0E] pt-6 pb-4 -mx-6 px-6 border-b border-border/10",children:[e.jsx("span",{className:"font-mono text-xs uppercase tracking-wider text-muted-foreground",children:"Table of contents"}),e.jsx("button",{onClick:()=>p(!1),"aria-label":"Close table of contents",className:"rounded-full p-2 text-muted-foreground transition hover:text-primary",children:e.jsx(be,{className:"h-4 w-4"})})]}),e.jsxs("button",{onClick:Te,className:"mb-4 flex w-full items-center gap-2 rounded-xl border border-border/50 px-4 py-3 text-left text-sm font-medium text-foreground transition hover:border-primary/50 hover:text-primary",children:[e.jsx(Fe,{className:"h-4 w-4 text-primary"}),"Back to top"]}),e.jsx("ul",{className:"space-y-2",children:ie()})]})]}),e.jsx(ee,{})]})},jn=()=>{const t=K();return l.useEffect(()=>{console.error("404 Error: User attempted to access non-existent route:",t.pathname)},[t.pathname]),e.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-100",children:e.jsxs("div",{className:"text-center",children:[e.jsx("h1",{className:"text-4xl font-bold mb-4",children:"404"}),e.jsx("p",{className:"text-xl text-gray-600 mb-4",children:"Oops! Page not found"}),e.jsx("a",{href:"/",className:"text-blue-500 hover:text-blue-700 underline",children:"Return to Home"})]})})},An=()=>e.jsxs(Ge,{children:[e.jsx(W,{path:"/",element:e.jsx(cn,{})}),e.jsx(W,{path:"/guides",element:e.jsx(bn,{})}),e.jsx(W,{path:"/guides/:slug",element:e.jsx(vn,{})}),e.jsx(W,{path:"*",element:e.jsx(jn,{})})]}),Nn=()=>{const{pathname:t,hash:n}=K();return l.useEffect(()=>{if(!n){window.scrollTo({top:0,left:0,behavior:"instant"});return}let r=!1;const h=n.slice(1),o=()=>{var u;r||(u=document.getElementById(h))==null||u.scrollIntoView({block:"start"})};o();const s=typeof document<"u"&&"fonts"in document?document.fonts.ready:Promise.resolve(),c=new Promise(u=>{window.setTimeout(u,500)});return Promise.race([s,c]).then(()=>{requestAnimationFrame(()=>requestAnimationFrame(o))}),()=>{r=!0}},[t,n]),null},In=()=>e.jsx(Qe,{children:e.jsxs(We,{children:[e.jsxs("svg",{className:"noise-overlay text-[0px]",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("filter",{id:"noiseFilter",children:e.jsx("feTurbulence",{type:"fractalNoise",baseFrequency:"0.65",numOctaves:"3",stitchTiles:"stitch"})}),e.jsx("rect",{width:"100%",height:"100%",filter:"url(#noiseFilter)"})]}),e.jsx(Nn,{}),e.jsx(An,{})]})});Oe.createRoot(document.getElementById("root")).render(e.jsx(In,{}));export{en as s};
